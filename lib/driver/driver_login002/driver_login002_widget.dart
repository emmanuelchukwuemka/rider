...
import 'driver_login002_model.dart';
export 'driver_login002_model.dart';

class DriverLogin002Widget extends StatefulWidget {
  const DriverLogin002Widget({super.key});

  static String routeName = 'DriverLogin002';
  static String routePath = '/driverLogin002';

  @override
  State<DriverLogin002Widget> createState() => _DriverLogin002WidgetState();
}

class _DriverLogin002WidgetState extends State<DriverLogin002Widget> {
  late DriverLogin002Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DriverLogin002Model());
  }
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () async {
                        context.pushNamed('DriverSignup');
                      },
                      child: wrapWithModel(
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: Container(
                        child: InkWell(
                          onTap: () async {
                            context.pushNamed('DriverForgotPassword004');
                          },
                          child: wrapWithModel(
                ...
                InkWell(
                  onTap: () async {
                    ...
                    if (result != null && result['token'] != null) {
                      ...
                      final driverName = result['driver']?['display_name']?.toString();
                      final driverPhone = result['driver']?['phone_number']?.toString();
                      await saveAuthData(result['token'], driverId, identifier, displayName: driverName, phoneNumber: driverPhone);
