export '/backend/schema/util/mock_firestore.dart';
...
abstract class FFSupabaseStruct extends BaseStruct {
  FFSupabaseStruct(this.firestoreUtilData);
...
Map<String, dynamic> mapFromFirestore(Map<String, dynamic> data) =>
    mergeNestedFields(data)
      ...
      // Handle Postgres string dates
      if (value is String && (key.contains('time') || key.contains('date') || key == 'created_at' || key == 'updated_at')) {
...
DocumentReference toRef(String ref) => SupabaseFirestore.instance.doc(ref);
