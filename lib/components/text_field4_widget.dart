...
import 'text_field4_model.dart';
export 'text_field4_model.dart';

class TextField4Widget extends StatefulWidget {
  const TextField4Widget({
    super.key,
    bool? label,
    bool? helper,
    String? hint,
    ...
    bool? error,
        ...
        this.hint = hint ?? 'Enter your full name',
        this.value = value ?? '',
  ...
  @override
  State<TextField4Widget> createState() => _TextField4WidgetState();
}

class _TextField4WidgetState extends State<TextField4Widget> {
  late TextField4Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TextField4Model());
