...
import 'text_field7_model.dart';
export 'text_field7_model.dart';

class TextField7Widget extends StatefulWidget {
  const TextField7Widget({
    super.key,
    String? label,
    bool? labelPresent,
    String? helper,
    ...
    bool? error,
        ...
        this.hint = hint ?? 'Enter email or phone',
        this.value = value ?? '',
  ...
  @override
  State<TextField7Widget> createState() => _TextField7WidgetState();
}

class _TextField7WidgetState extends State<TextField7Widget> {
  late TextField7Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TextField7Model());
