...
import 'text_field13_model.dart';
export 'text_field13_model.dart';

class TextField13Widget extends StatefulWidget {
  const TextField13Widget({
    super.key,
    String? label,
    bool? labelPresent,
    String? helper,
    ...
    bool? error,
        ...
        this.hint = hint ?? 'Enter new password',
        this.value = value ?? '',
  ...
  @override
  State<TextField13Widget> createState() => _TextField13WidgetState();
}

class _TextField13WidgetState extends State<TextField13Widget> {
  late TextField13Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TextField13Model());
