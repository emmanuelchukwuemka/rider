...
import 'text_field10_model.dart';
export 'text_field10_model.dart';

class TextField10Widget extends StatefulWidget {
  const TextField10Widget({
    super.key,
    String? label,
    bool? labelPresent,
    String? helper,
  ...
  @override
  State<TextField10Widget> createState() => _TextField10WidgetState();
}

class _TextField10WidgetState extends State<TextField10Widget> {
  late TextField10Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TextField10Model());
