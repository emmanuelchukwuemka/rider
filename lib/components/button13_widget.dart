...
import 'button13_model.dart';
export 'button13_model.dart';

class Button13Widget extends StatefulWidget {
  const Button13Widget({
    super.key,
    String? content,
    this.icon,
    bool? iconPresent,
    ...
    bool? loading,
    bool? disabled,
  })  : this.content = content ?? 'Cancel Ride',
  ...
  @override
  State<Button13Widget> createState() => _Button13WidgetState();
}

class _Button13WidgetState extends State<Button13Widget> {
  late Button13Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Button13Model());
