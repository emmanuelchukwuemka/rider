...
import 'checkbox3_model.dart';
export 'checkbox3_model.dart';

class Checkbox3Widget extends StatefulWidget {
  const Checkbox3Widget({
    super.key,
    String? label,
    String? subtitle,
    Color? color,
  ...
  @override
  State<Checkbox3Widget> createState() => _Checkbox3WidgetState();
}

class _Checkbox3WidgetState extends State<Checkbox3Widget> {
  late Checkbox3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Checkbox3Model());
