...
import 'button10_model.dart';
export 'button10_model.dart';

class Button10Widget extends StatefulWidget {
  const Button10Widget({
    super.key,
    String? content,
    this.icon,
    bool? iconPresent,
    ...
    bool? loading,
    bool? disabled,
  })  : this.content = content ?? 'Send Reset Link',
  ...
  @override
  State<Button10Widget> createState() => _Button10WidgetState();
}

class _Button10WidgetState extends State<Button10Widget> {
  late Button10Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Button10Model());
