...
import 'text_field12_model.dart';
export 'text_field12_model.dart';

class TextField12Widget extends StatefulWidget {
  const TextField12Widget({
    super.key,
    String? label,
    bool? labelPresent,
    String? helper,
    ...
    String? variant,
    bool? error,
  })  : this.label = label ?? 'Driver Email Address',
        this.labelPresent = labelPresent ?? true,
        this.helper = helper ?? '',
        this.helperPresent = helperPresent ?? false,
        this.hint = hint ?? 'driver.name@fleet.com',
        this.value = value ?? '',
  ...
  @override
  State<TextField12Widget> createState() => _TextField12WidgetState();
}

class _TextField12WidgetState extends State<TextField12Widget> {
  late TextField12Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TextField12Model());
